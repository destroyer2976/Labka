...
#road image
background = pygame.image.load("/Users/zasulan/Downloads/fornastrgit/lab8/AnimatedStreet.png")

#background music
music="/Users/zasulan/Downloads/fornastrgit/lab8/background.wav"
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/zasulan/Downloads/coin.png")
        self.rect = self.image.get_rect()
...
class Coin2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/zasulan/Downloads/coin2.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(30, w - 30), 0)
...
class Coin3(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/zasulan/Downloads/coin3.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(30, w - 30), 0)
