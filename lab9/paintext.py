...
def setsurf():
    ...
    tr1 = pygame.image.load("/Users/zasulan/Downloads/right_triangle.png")
    buttons.blit(tr1, (8, 8))
    tr2 = pygame.image.load("/Users/zasulan/Downloads/equilateral-triangle.png")
    buttons.blit(tr2, (8, 55))
    pygame.draw.rect(buttons, 'black', (58, 10, 32, 32), 2)
    rh = pygame.image.load("/Users/zasulan/Downloads/rhombus.png")
