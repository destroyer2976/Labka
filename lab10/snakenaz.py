...
cur.execute('''CREATE TABLE IF NOT EXISTS players22 (
...
pygame.display.set_icon(pygame.image.load("/Users/zasulan/Downloads/fornastrgit/lab10/icon.png"))
...
# fruit
fruit = pygame.transform.scale(pygame.image.load("/Users/zasulan/Downloads/fornastrgit/lab10/food.png"), (20, 10))
fruit_pos = [random.randrange(1, (w//10)) * 10, random.randrange(1, (h//10)) * 10]
fruit_spawn = True
# fruit2
fruit2 = pygame.transform.scale(pygame.image.load("/Users/zasulan/Downloads/fornastrgit/lab10/food2.png"), (20, 10))
fruit2_pos = [random.randrange(1, (w//10)) * 10, random.randrange(1, (h//10)) * 10]
fruit2_spawn = True
# fruit3
fruit3 = pygame.transform.scale(pygame.image.load("/Users/zasulan/Downloads/fornastrgit/lab10/food3.png"), (20, 10))
fruit3_pos = [random.randrange(1, (w//10)) * 10, random.randrange(1, (h//10)) * 10]
fruit3_spawn = True
# fruit4
fruit4 = pygame.transform.scale(pygame.image.load("/Users/zasulan/Downloads/fornastrgit/lab10/food4.png"), (20, 10))
